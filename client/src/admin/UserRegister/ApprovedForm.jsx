...
const ApprovedForm = () => {
        ...
        <Sidebar>
          <div className="clear">
            <div className="section_heading">
              <h2 className="title_heading">Approve Registration</h2>
            </div>
            <div
              className="clear"
    ...
    //             <h3 className="text-success mb-4">{formData.is_rejected === "Pending" ? "Pending" : formData.is_rejected === "Approved" ? "Approved" : `Rejected`}</h3>
    //             <form onSubmit={handleSubmit}>
    //                 <div className="row">
    //                     <div className="col-md-6">
    //                         <div className="mb-3">
